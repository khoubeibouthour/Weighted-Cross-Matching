    ...
    for candidate in candidates:
        ...
        for reference in references:
            ...
            if not wasCreated:
                wasCreated = True
                f = open(filename, "w+")
                f.write('fr_direct,fr_comp,fr_ref,same_path,diff_nbr_faces,diff_filesize,same_imagewidth,diff_datetimeoriginal,distance,same_orientation,same_model,response')
